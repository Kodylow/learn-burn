; ModuleID = 'probe8.1cada5af80218b70-cgu.0'
source_filename = "probe8.1cada5af80218b70-cgu.0"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx11.0.0"

; core::f64::<impl f64>::to_ne_bytes
; Function Attrs: inlinehint uwtable
define internal i64 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$11to_ne_bytes17h4d95151a422db94fE"(double %self) unnamed_addr #0 {
start:
...
define void @_ZN6probe85probe17h1995cf36fb3a2fe4E() unnamed_addr #1 {
start:
  %0 = alloca i64, align 8
  %_1 = alloca [8 x i8], align 1
; call core::f64::<impl f64>::to_ne_bytes
  %1 = call i64 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$11to_ne_bytes17h4d95151a422db94fE"(double 3.140000e+00)
